...
- **Farms.** A record of the wine farms you've visited: check in to capture the GPS location (works offline), add a photo, a star rating out of 5 (half-stars supported), the date and a review. **Open in Maps** drops you on the pin, and **Share** sends the farm — name, place, rating, date, your review and a Maps link — to WhatsApp or anywhere else via the phone's share sheet. Farms added without a check-in still work: the link searches Maps by name instead.
